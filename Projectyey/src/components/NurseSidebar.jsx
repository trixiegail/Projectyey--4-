...
const Sidebar = () => {
  const { nurse, logoutNurse } = useAuth();
  ...
  const menuItems = [
    { text: 'Dashboard', icon: <DashboardIcon />, path: '/nursedashboard' },
    { text: 'Nurse', icon: <LocalHospitalIcon />, path: '/nursetorlist' },
    { text: 'Patients', icon: <PeopleIcon />, path: '/patientlist' },
  ];

  const manageItems = [
    { text: 'Calendar', icon: <CalendarTodayIcon />, path: '/nursecalendar' },
    { text: 'Applicants', icon: <EventAvailableIcon />, path: '/CheckupApplicantList' },
    // { text: 'Forms', icon: <DescriptionIcon />, path: '/nurseforms' },
    { text: 'Settings', icon: <SettingsIcon />, path: '/nursesettings' },
  ];
