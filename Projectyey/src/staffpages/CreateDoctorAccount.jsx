...
function CreateDoctorAccount(){
    ...
    const handleChange = async () => {
        ...
        try {
            const response = await axios.post("https://dentalmanagement.azurewebsites.net/doctor/insertDoctor", doctor_data);
    ...
    return (
        <div className="ml-[265px] min-h-screen flex flex-col items-center justify-center bg-gradient-to-b ">
            ...
            <div className="w-full max-w-4xl p-8 space-y-6 bg-[#88343B] rounded-lg shadow-md">
                <h1 className="text-2xl font-bold text-center text-white">Create Doctor Account</h1>
