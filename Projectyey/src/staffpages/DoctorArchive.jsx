...
function DoctorArchive() {
    ...
    const fetchArchivedAccounts = async () => {
        try {
            const response = await axios.get('https://dentalmanagement-app.onrender.com/doctor/getAllArchivedDoctors');
    ...
    const handleSearch = async () => {
        try {
            const response = await axios.get(`https://dentalmanagement-app.onrender.com/doctor/search/archivedDoctors?keyword=${searchTerm}`);
            if (response.status === 200) {
                setArchivedAccounts(response.data);
    ...
    const handleUnarchive = async (id) => {
        try {
            const response = await axios.post(`https://dentalmanagement-app.onrender.com/doctor/unarchiveDoctor/${id}`);
            if (response.status === 200) {
