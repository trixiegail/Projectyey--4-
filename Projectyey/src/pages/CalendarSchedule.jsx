...
const confirmEventCreation = () => {
  ...
  return (
    <div>
      ...
      <Button onClick={() => setShowModal(true)} color="primary" variant="contained" style={{marginBottom:'10px', backgroundColor:'#88343B'}}>
...
<div style={{ marginBottom: '20px', marginLeft: '30px', backgroundColor:'white' }}>
